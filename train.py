...
# data I/O
parser.add_argument('-o', '--save_dir', type=str, default='data', help='Location for parameter checkpoints and samples')
...
train_data = H5PYDataset(
    '/u/alitaiga/repositories/count-based-exploration/data/montezuma_color.h5', which_sets=('train',), sources=('images',)
)
